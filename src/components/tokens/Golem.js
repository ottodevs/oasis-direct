    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" className="GolemToken">
        <g fill="none" fillRule="evenodd">
          <path className="GolemToken" fillRule="nonzero"
          ...
          <ellipse cx="13.806" cy="18.283" stroke="#FFF" strokeWidth="1.025" rx="2.864" ry="2.691"/>
          <path stroke="#FFF" strokeLinecap="square" strokeWidth="1.025"
                d="M13.944664,13.0280992 L13.944664,15.2196503"/>
          <ellipse cx="13.806" cy="10.08" stroke="#FFF" strokeWidth="1.025" rx="2.864" ry="2.691"/>
          <path stroke="#FFF" strokeLinecap="square" strokeWidth="1.025"
